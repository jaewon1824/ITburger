...
<div class="join">
       <div id="chkPop" class="popup">
                ...
                <ul class="join-check01">
                    ...
                    <li>
                        ...
                        <li>
                            ...
                            <label for="terms06"><span>IT burger   통합 서비스(필수)</span></label><a href="#" onclick="$('#06').addClass('active');">(상세보기)</a>
                            
                                
                            <div id="06" class="popup">
                                <div class="pop-wrap">
                                    <div class="pop-title">
                                        <h6>IT burger 통합 서비스</h6>
                                        <button class="close" type="button" onclick="$('#06').removeClass('active');"></button>
                                    </div>
                                    <div class="pop-cont">
                                            <p style="font-size: 16px; font-weight: 500;">IT burger   통합 서비스</p><br>
        <p style="font-size: 14px; font-weight: 500;">제 1 조 (목적)</p>
        본 약관은 IT burger  가 통합 서비스 회원(이하 "회원")에게 다양한 서비스를 제공하고, 고객서비스 증진을 도모함에 있어 필요한 제반 사항을 정하는데 그 목적이 있습니다.<br>
        <br><br>
        <p style="font-size: 14px; font-weight: 500;">제 2 조 (용어의 정의)</p>
        1) "IT burger   통합 서비스"란 통합 서비스(웹, 앱) 가입자에게 제공하는 고객관리 프로그램으로서 커뮤니티 서비스를 제공하는 경우 각종 혜택을 받거나 이벤트에 참여할 수 있도록 하는 서비스를 말합니다. <br>
        2) "회원"이란 IT burger  가 정한 기준 및 절차에 따라 가입을 완료하고 통합 서비스를 이용할 수 있는 권한을 획득한 고객을 말합니다. 단, 회원자격은 제 3 조 이하에서 규정합니다. <br>
        3) "제휴가맹점"이란 IT burger  와 계약 또는 협약을 통해 "IT burger   통합 서비스"를 제공하는 자를 말합니다. <br>
        4) "적립포인트"란 회원이 IT burger  에서 진행하는 이벤트에 참여하면서 고지한 기준에 따라 부여되는 포인트를 말합니다. <br>
        ...
        &nbsp;- IT burger   통합 서비스에 가입한 명의자 본인<br>
        ...
        3) 고객으로부터 회원가입신청이 있는 경우 IT burger  는 자체 기준에 따른 심사를 거친 뒤 기준을 만족하는 회원가입신청 고객께 "IT burger   회원 바코드"를 발급하여 드립니다.<br>
        4) 회원은 회원자격을 타인에게 양도하거나 대여 또는 담보의 목적으로 이용할 수 없습니다.<br>
        <br>
        <br>
        <p style="font-size: 14px; font-weight: 500;">제 4 조 (IT burger   회원 바코드의 이용 등)</p>
        1) IT burger   회원 바코드는 회원 본인에 한하여 사용이 가능하며, 타인에게 대여하거나 양도 또는 담보의 목적으로 이용할 수 없습니다.<br>
        2) 회원은 주소, 전화번호 등 개인정보가 변경된 경우 웹 홈페이지에서 즉시 변경하여야 하며 회원이 통지하지 않음으로써 발생되는 모든 결과는 회원의 책임입니다.<br>
        3) IT burger   통합 서비스 이용에 따라 발생될 수 있는 제세공과는 회원이 부담합니다.<br>
        <br>
        <br>
        <p style="font-size: 14px; font-weight: 500;">제 5 조 (IT burger   통합 서비스 및 제휴가맹점)</p>
        1) IT burger   통합 서비스와 제휴가맹점 현황 및 각종 이벤트 행사는 웹 홈페이지에서 확인이 가능합니다.<br>
        2) 회원이 제휴가맹점에서 IT burger   통합 서비스를 이용하거나, 이벤트 행사에 참가하고자 하는 때에는 IT burger   회원 바코드를 제시하여야 하며, 회원 본인 여부 확인을 위하여 제휴가맹점이나 이벤트 진행자가 신분증의 제시 등을 요구할 수 있습니다.<br>
        <br>
        <br>
        <p style="font-size: 14px; font-weight: 500;">제 6 조 (탈퇴 및 환불)</p>
        1) IT burger   통합 서비스를 탈퇴하고자 할 때는 웹 홈페이지에서 신청하면 즉시 처리됩니다.<br>
        2) IT burger   회원을 탈퇴하면 적립포인트는 소멸됩니다.<br>

        <br>
        <br>
        <p style="font-size: 14px; font-weight: 500;">제 7 조 (IT burger   통합 서비스 이용 제한 등)</p>
        1) 회원이 다음 각 호에 해당할 경우 회원가입 또는 IT burger   통합 서비스 이용이 제한됩니다.<br>
        &nbsp;- 회원이 스스로 회원탈퇴 의사를 밝힌 경우<br>
        &nbsp;- 타인의 명의를 이용한 회원가입으로 인하여 명의자와 다툼이 발생한 경우 명의를 이용한 해당 회원은 이와 관련한 모든 문제에 대하여 책임을 부담하며, 해당 회원의 회원자격 및 IT burger   통합 서비스 이용을 직권으로 정지 또는 박탈하는 등의 제한을 가할 수 있습니다.<br>
        <br>
        <br>
        <p style="font-size: 14px; font-weight: 500;">제 8 조 (개인정보보호)</p>
        1) 구단은 회원의 가입신청 또는 IT burger   통합 서비스 제공에 필요한 회원의 개인정보(가입신청서에 기재된 가입신청자의 정보 및 IT burger   통합 서비스 이용에 관한 정보 등)를 수집, 이용할 수 있으며, 이를 분석하여 보다 향상된 서비스를 제공하기 위한 마케팅 활동에 사용하거나 NC 다이노스 통합 서비스 관련 업무의 위탁업체, 제휴가맹점 등 제 3자에게 제공할 수 있습니다.<br>
        2) 구단은 회원의 개인정보를 수집, 이용, 위탁하거나 제 3자에게 제공하고자 하는 회원으로부터 개인정보의 수집, 이용, 위탁, 및 제공에 관한 동의를 얻어야 합니다.<br>
        3) 회원의 개인정보가 제공되는 IT burger   통합 서비스 관련 업무의 위탁업체 및 제휴가맹점 등은 IT burger   웹 홈페이지에서 확인이 가능합니다.<br>
        <br>
        <br>
        <p style="font-size: 14px; font-weight: 500;">제 9 조 (SMS, 카카오 알림톡, e-mail 수신 동의 등)</p>
        IT burger   통합 서비스는 제공 및 이용과 관련된 정보 제공을 위한 SMS(LMS, MMS 포함), 카카오 알림톡, e-mail 수신에 동의한 회원에게 해당 채널을 통해 IT burger   통합 서비스와 관련된 각종 정보를 제공할 수 있습니다.<br>
        <br>
        <br>
        <p style="font-size: 14px; font-weight: 500;">제 10 조 (약관 개정)</p>
        1) IT burger  가 본 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 구단 홈페이지에 그 적용일자 30일 전부터 적용일자 전일까지 공지합니다. 단, 회원에게 불리한 약관의 개정의 경우에는 공지 외에 서비스 내 e-mail, 로그인 시 팝업창 등의 전자적 수단이나 SMS/카카오 알림톡 발송 등을 통해 따로 명확히 통지하도록 합니다.<br>
        3) 회원이 개정약관에 동의하지 않는 경우 IT burger   개정약관의 내용을 적용할 수 없으며, 이 경우 회원은 회원 탈퇴할 수 있습니다.<br>
        4) 회원은 전항에 따른 IT burger   통합 서비스 중단 또는 종료로 손해를 입은 경우 서면으로 손해액과, 손해액의 내용 및 산출근거 등을 기재하고 입증자료를 첨부하여 구단에 이에 대한 배상을 청구할 수 있습니다.<br>
        <br>
        <br>
        ...
        IT burger  스 통합 서비스와 관련하여 회원과 구단간에 분쟁이 발생하는 경우 당사자 간의 성실한 상호 협의에 따라 해결함을 원칙으로 합니다. 다만, 협의가 이루어지지 아니한 경우에는 양 당사자는 민사소송상의 관할법원에 소송을 제기할 수 있습니다.<br>
                                    </div>
                                </div>
                            </div>
        ...
        'IT burger  ' (이하 '회사')는 회원의 개인정보를 중요시하며, 「개인정보보호법」등 회사가 준수하여야 할 관련 법령상의 개인정보보호 규정을 준수하고 있습니다. 회사는 개인정보처리방침을 통하여 회원님께서 제공하시는 개인 정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다. 회사는 개인정보처리방침을 개정하는 경우 모바일앱 공지사항(또는 개별공지)을 통하여 사전 공지할 것입니다.
        <br><br>
	...
	<br>
        ...
        IT burger는 마케팅 정보 안내를 위한 광고성 정보 수신에 동의하신 분을 대상으로 서비스에 대한 새로운 소식이나 이벤트 정보를 전달하고자 합니다.
        귀하는 ㈜KOREA IT가 발송하는 광고성 정보를 수신할 수 있으며, 광고성 정보에 기재되어 있는 수신거부 안내방법에 따라 수신을 거부하실 수 있습니다.
                                    </div>
                                </div>
                            </div>
                        </li>
